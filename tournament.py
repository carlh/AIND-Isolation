...
def main():
    ...
    test_agents = [
        Agent(AlphaBetaPlayer(score_fn=improved_score, timeout=35.), "AB_Improved"),
        Agent(AlphaBetaPlayer(score_fn=custom_score, timeout=35.), "AB_Custom"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_2, timeout=35.), "AB_Custom_2"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_3, timeout=35.), "AB_Custom_3")
    ]
